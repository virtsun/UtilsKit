...
@protocol BlockFlowLayoutDelegate <UICollectionViewDelegate>
@optional
...
@interface BlockFlowLayout : UICollectionViewLayout
@property (nonatomic, weak) IBOutlet NSObject<BlockFlowLayoutDelegate>* delegate;
