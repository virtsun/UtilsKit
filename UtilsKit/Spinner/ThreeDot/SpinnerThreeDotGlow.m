...
#import "SpinnerThreeDotGlow.h"

@interface SpinnerThreeDotGlow ()
{
...
-(void)initAnimation;
@end
@implementation SpinnerThreeDotGlow
...
-(void) initThreeDot
{
    ...
    for (NSInteger i = 0; i < 3; i++)
    {
        ...
        dot.frame = frame;
        dot.backgroundColor = UIColorFromRGB(0xe67e03).CGColor;
        dot.cornerRadius = 10;;
        dot.shadowColor = UIColorFromRGB(0xe67e03).CGColor;
        dot.shadowOpacity = 1;
...
-(void)initAnimation
{
    ...
    _colorGlowAnimation.keyTimes = @[[NSNumber numberWithFloat:0.0f],
                                [NSNumber numberWithFloat:0.5f],
                                [NSNumber numberWithFloat:1.0f]];
    _colorGlowAnimation.values = @[(id) UIColorFromRGB(0xff0000).CGColor,
                              (id)UIColorFromRGB(0x00ff00).CGColor,
                              (id)UIColorFromRGB(0xff0000).CGColor];
    ...
    _colorDotAnimation.keyTimes = @[[NSNumber numberWithFloat:0.0f],
                                [NSNumber numberWithFloat:0.5f],
                                [NSNumber numberWithFloat:1.0f]];
     _colorDotAnimation.values = @[(id) UIColorFromRGB(0xff0000).CGColor,
            (id)UIColorFromRGB(0x00ff00).CGColor,
            (id)UIColorFromRGB(0xff0000).CGColor];
